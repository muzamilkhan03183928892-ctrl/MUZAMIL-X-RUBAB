...
╰──────────●●►
╭──────────●●►
│ *Hello , ᴍᴜᴢᴀᴍɪʟ x ʀᴜʙᴀʙ alive now!!*
╰──────────●●►
...
console.log(`ᴍᴜᴢᴀᴍɪʟ x ʀᴜʙᴀʙ ♻ Auto Bio Started`);
//============================ Env=======================================================
...
async (conn, mek, m, { from }) => {
    try {
        ...
        const ownerNumber = '+923183928892'; // Replace this with the actual owner number
        const ownerName = 'ᴍᴜᴢᴀᴍɪʟ x ʀᴜʙᴀʙ Official'; // Replace this with the owner's name
        const organization = 'ᴍᴜᴢᴀᴍɪʟ x ʀᴜʙᴀʙ CODERS'; // Optional: replace with the owner's organization
        ...
        await conn.sendMessage(from, {
            ...
            contextInfo: {
                mentionedJid: [ownerNumber.replace('+923183928892', '') + '+923183928892@s.whatsapp.net'], // Mention the owner
...
try{
    ...
    let ping = await conn.sendMessage(from , { text: '*_ᴍᴜᴢᴀᴍɪʟ x ʀᴜʙᴀʙ..._*'  }, { quoted: mek } )
...
try{
let dec = `> ᴍᴜᴢᴀᴍɪʟ x ʀᴜʙᴀʙ REPO INFO 🪀

╭⦁⦂⦁*━┉━┉━┉━┉━┉━┉━⦁⦂⦁
┃ 𝙾𝚆𝙽𝙴𝚁 𝙽𝚄𝙼𝙱𝙴𝚁: ${bot.OWNER_NUMBER}
┃ 
┃ ᴍᴜᴢᴀᴍɪʟ x ʀᴜʙᴀʙ REPO: ${bot.REPO_LINK} 
┃
...
async (conn, mek, m, { from, quoted, body, isCmd, command, args, q, isGroup, sender, senderNumber, botNumber2, botNumber, pushname, isMe, isOwner, groupMetadata, groupName, participants, groupAdmins, isBotAdmins, isAdmins, reply }) => {
    try {
        ...
        const vv = await conn.sendMessage(from, {
            image: { url:bot.ALIVE_IMG},
            caption: `> ᴍᴜᴢᴀᴍɪʟ x ʀᴜʙᴀʙ Settings\n
┏━━━━━━━━━━━━━━━━━━┓
┃╭┈────────━━━━───╮
┣┣Work Mode : *${work}*
...
┃
┃ 👨‍💻  *Owners :-* ᴍᴜᴢᴀᴍɪʟ x ʀᴜʙᴀʙ Official 🇵🇰 
┃
┃ 🧬 *Version :-* ${bot.VERSION}
┃
*⦁⦂⦁*━┉━┉━┉━┉━┉━┉━┉━⦁⦂⦁
  ...
  async (conn,mek, m, { from, body, isGroup, isAdmins, isBotAdmins, reply, sender }) => {
      try {
          ...
          if (containsBadWord & config.ANTI_BAD === 'true') {
            ...
            await conn.sendMessage(from, { text: "🚫 ⚠️BAD WORDS NOT ALLOWED⚠️ 🚫OTHER WISE MUZAMIL WILL FUCK U" }, { quoted: mek });
          }
      } catch (error) {
          console.error(error)
  ...
  cmd({
      ...
      try {
          ...
          if (containsLink && config.ANTI_LINK === 'true') {
              ...
              // Warn the user
              await conn.sendMessage(from, { text: `⚠️ Links are not allowed in this group.\n@${sender.split('@')[0]} has been removed. 🚫by: ᴍᴜᴢᴀᴍɪʟ x ʀᴜʙᴀʙ`, mentions: [sender] }, { quoted: mek });
